    ...
    return (
        <div className="">
            <div className="p-20 flex flex-row items-center justify-between">
                <div className="">
                    <h1 className="font-bold text-2xl">Marketing Contact Management</h1>
                    <h4 className="text-gray-400">Manage marketing team contacts</h4>
                </div>
                <div>
                    <button className="bg-black h-10 rounded-lg w-50 text-white flex flex-row items-center justify-center rounded-ld gap-2">
                        <h1 className="text-2xl font-bold mb-1">+</h1>
                        <h4 className="text-sm font-bold">Add Marketing Contact</h4>
                    </button>
                </div>
            </div>
            <div className="bg-white border border-gray-300 rounded-lg  h-35 w-280 ml-20">
                <h4 className="font-semibold text-md p-4">Search Marketing Contacts</h4>
                <div className="flex flex-row gap-3">
                    <div className="relative mt-2 p-2 mb-3 ml-4 flex flex-row gap-3 items-center justify-center ">
                        ...
                        <input type="text" placeholder="Search by name and email...." className="h-8 w-250 text-sm bg-gray-200 text-black rounded-lg pl-10 pr-2 text-sm" />
            ...
            <div className="bg-white border border-gray-300 h-120 w-280 p-6 py-10 rounded-lg ml-20 mt-6">
                <h4 className="font-bold">All Marketing Contacts (3) </h4>
                <p className="text-sm">Manage your marketing team contacts</p>

                <div className="bg-white border border-gray-300 flex flex-row justify-between w-270 mt-6 h-24  rounded-lg">
                    <div className="flex items-center gap-2 ml-4">
                        <div className="font-bold flex items-center mt-4 justify-center bg-gray-300 text-2xl p-4 h-15 w-15  text-white rounded-full">
                            <h4>AB</h4>
                        </div>
                        <div className="">
                ...
                <div className="bg-white border border-gray-300 flex flex-row justify-between w-270 mt-6 h-24  rounded-lg">
                    <div className="flex items-center gap-2 ml-4">
                        <div className="font-bold flex items-center mt-4 bg-gray-300 justify-center text-2xl p-4 h-15 w-15  text-white rounded-full">
                            <h4>AB</h4>
                        </div>
                        <div className="">
                            <div className="flex flex-row gap-2 mt-3 items-center justify-center">
